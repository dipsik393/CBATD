...
git 
    ...
    # threshold decision
    if max_score < 0.50:
        final_result = "SAFE — No cyber threat detected"
        status_class = "safe"

    elif max_score < 0.75:
        final_result = f"WARNING — Potential {threat_type} content detected"
        status_class = "warning"

    else:
        final_result = f"CYBER THREAT DETECTED — {threat_type}"
        status_class = "threat"

    # Send ONLY summary to frontend
